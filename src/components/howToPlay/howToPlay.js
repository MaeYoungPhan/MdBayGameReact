...
export const HowToPlay = () => {
				...
				return <>
					...
					<p className="playRules">1. Start looking <b>NOW</b> for <Link className="link" to="/riversandstreams">rivers and streams</Link> that you cross on the way to Ocean City. All have been marked with a sign. One activity challenges you to find all these rivers and streams.</p>
